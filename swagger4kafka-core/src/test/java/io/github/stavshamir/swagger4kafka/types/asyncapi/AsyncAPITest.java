package io.github.stavshamir.swagger4kafka.types.asyncapi;

import com.fasterxml.jackson.databind.ObjectMapper;
import com.google.common.collect.ImmutableMap;
import io.github.stavshamir.swagger4kafka.types.asyncapi.channel.Channel;
import io.github.stavshamir.swagger4kafka.types.asyncapi.channel.operation.Operation;
import io.github.stavshamir.swagger4kafka.types.asyncapi.channel.operation.bindings.kafka.KafkaOperationBinding;
import io.github.stavshamir.swagger4kafka.types.asyncapi.channel.operation.message.Message;
import io.github.stavshamir.swagger4kafka.types.asyncapi.channel.operation.message.PayloadReference;
import io.github.stavshamir.swagger4kafka.types.asyncapi.info.Contact;
import io.github.stavshamir.swagger4kafka.types.asyncapi.info.Info;
import io.github.stavshamir.swagger4kafka.types.asyncapi.info.License;
import io.github.stavshamir.swagger4kafka.types.asyncapi.server.Server;
...
public class AsyncAPITest {
    ...
    public void AsyncAPI_should_map_to_a_valid_asyncapi_json() throws IOException, JSONException {
        ...
        Map<String, Model> schemas = ModelConverters.getInstance().read(ExamplePayload.class);
