package io.github.stavshamir.swagger4kafka.validation;
...
import static io.github.stavshamir.swagger4kafka.validation.PayloadValidator.validate;
...
public class PayloadValidatorTest {
    ...
    public void validate_incorrectEnumValue() {
        ...
        assertThat(validation.getMessage())
                .isEqualTo("Cannot deserialize value of type `io.github.stavshamir.swagger4kafka.validation.PayloadValidatorTest$FooWithEnum$Bar` from String \"wrong\": value not one of declared Enum instance names: [BAR1, BAR2] at \"b\"");
    }
