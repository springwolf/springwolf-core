...
@TestPropertySource(
        properties = {
            ...
            "springwolf.payload.extractable-classes.my.custom.class=3"
        })
public class SpringwolfConfigPropertiesIntegrationTest {
    ...
    void payloadTest() {
        ...
        // custom value added in test
        assertThat(actual).containsEntry("my.custom.class", 3);
    }
}
