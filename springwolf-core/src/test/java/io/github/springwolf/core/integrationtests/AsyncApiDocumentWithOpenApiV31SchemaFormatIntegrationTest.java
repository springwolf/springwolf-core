...
public class AsyncApiDocumentWithOpenApiV31SchemaFormatIntegrationTest {
    ...
    @TestPropertySource(
            properties = {
                ...
                "springwolf.docket.payload-schema-format=openapi_v3_1"
            })
    ...
    class PolymorphicPayloadTest {
        ...
        void polymorphicDiscriminatorFieldIsHandled() throws JsonProcessingException {
            ...
            AsyncAPI asyncAPI = asyncApiService.getAsyncAPI();
            //
            // System.out.println(Json.mapper().writerWithDefaultPrettyPrinter().writeValueAsString(asyncAPI));
    ...
    class SchemaAsRefTest {
        ...
        void enumAsRefIsHandled() {
            ...
            assertThat(schemas.get(myEnumRootSchemaName).getMultiFormatSchema().getSchemaFormat())
                    .isEqualTo(SchemaFormat.OPENAPI_V3_1.value);
