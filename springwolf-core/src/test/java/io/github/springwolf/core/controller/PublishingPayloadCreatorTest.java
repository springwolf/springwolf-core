...
class PublishingPayloadCreatorTest {
    ...
    void shouldResolveBooleanPayload() throws Exception {
        ...
        when(jsonMapper.readValue(payload, Boolean.class)).thenReturn(payloadTyped);
    ...
    void shouldResolveIntegerPayload() throws Exception {
        ...
        when(jsonMapper.readValue(payload, Long.class)).thenReturn(payloadTyped);
    ...
    void shouldResolveFloatPayload() throws Exception {
        ...
        when(jsonMapper.readValue(payload, Double.class)).thenReturn(payloadTyped);
    ...
    void shouldResolveObjectPayload() throws Exception {
        ...
        when(jsonMapper.readValue(payload, ObjectClass.class)).thenReturn(payloadTyped);
    ...
    void shouldResolveStringPayload() throws Exception {
        ...
        when(jsonMapper.readValue(payload, String.class)).thenReturn(payloadTyped);
