...
class SendToUserUtilTest {
    ...
    public class ChannelName {
        ...
        void fromTopics() {
            ...
            // when
            String channelName = SendToUserUtil.getChannelName(annotation, resolver);
    ...
    void buildOperationBinding() {
        ...
        // when
        Map<String, OperationBinding> operationBinding = SendToUserUtil.buildOperationBinding(annotation, resolver);
