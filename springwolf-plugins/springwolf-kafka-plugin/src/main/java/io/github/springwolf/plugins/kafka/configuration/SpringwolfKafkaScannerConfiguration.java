...
import io.github.springwolf.plugins.kafka.asyncapi.scanners.bindings.KafkaBeanRefHelper;
...
public class SpringwolfKafkaScannerConfiguration {
    ...
    @ConditionalOnProperty(
            ...
            havingValue = "true",
            matchIfMissing = true)
    public KafkaBeanRefHelper kafkaBeanRefHelper(StringValueResolver stringValueResolver) {
        return new KafkaBeanRefHelper(stringValueResolver);
    }
    ...
    @ConditionalOnProperty(
            ...
            havingValue = "true",
            matchIfMissing = true)
    public KafkaBindingFactory kafkaBindingFactory(KafkaBeanRefHelper kafkaBeanRefHelper) {
        return new KafkaBindingFactory(kafkaBeanRefHelper);
    }
